  ...
  $.get(loadImgs, function (data) {
    for (var i = 0; i < data.length; i++) {
      $("#imgtable").append('<tr class="trdb" id="trdb' + data[i].id +
        '"><td><div class="thumbnail"><img style="width:150px;" src="' + data[i].image +
        '" alt="Ad Image"></div></td><td><button type="button" class="btn btn-danger pull-right rmvbtndb" data-indb="' +
...
$.get(variantRoute, (datas) => {

  variants.push(datas)
});

$.get(addonRoute, (datas) => {
