            ...
            <div class="row justify-content-center">
              @foreach ($features as $feature)
                <div class="col-xl-4 col-sm-6" data-aos="fade-up">
                  <div class="card mb-30">
                    <div class="card-icon">
                      <img src="{{ asset('assets/front/img/features/' . $feature->image) }}" alt="Icon">
                    </div>
                    <div class="card-content">
                  ...
                  @foreach ($featured_users as $featured_user)
                    <div class="swiper-slide">
                      <div class="card" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon">
                          <img
                            src="{{ $featured_user->image ? asset(Constant::WEBSITE_TENANT_USER_IMAGE . '/' . $featured_user->image) : asset('assets/front/img/user/profile.jpg') }}"
                            alt="User">
                        </div>
                        <div class="card-content">
            ...
            <div class="row align-items-center gx-xl-5">
              <div class="col-lg-6">
                <div class="image image-left mb-30" data-aos="fade-right">
                  <img src="{{ asset('assets/front/img/testimonials/' . $be->testimonial_img) }}" alt="Image">
                </div>
              </div>
              <div class="col-lg-6">
                ...
                <article class="card mb-30" data-aos="fade-up" data-aos-delay="100">
                  <div class="card-image">
                    ...
                    <ul class="info-list">
                      ...
                      <li>
                        <i class="fal fa-calendar"></i>{{ \Carbon\Carbon::parse($blog->created_at)->format('F j, Y') }}
                      </li>
              ...
              <div class="swiper sponsor-slider">
                <div class="swiper-wrapper">
                  @foreach ($partners as $partner)
                    <div class="swiper-slide">
                      <div class="item-single d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
                        <div class="sponsor-img">
                          <a href="{{ $partner->url }}" target="blank">
                            <img class="lazyload blur-up"
                              src="{{ asset('assets/front/img/partners/' . $partner->image) }}" alt="Sponsor">
                          </a>
                        </div>
                      </div>
                    </div>
