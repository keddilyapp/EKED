            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="secret_key" value="{{ @$yocoInfo['secret_key'] }}">
              ...
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="key"
                    value="{{ isset($paystackInfo) ? $paystackInfo['key'] : null }}">
                  @if ($errors->has('key'))
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="key"
                    value="{{ isset($mollieInfo) ? $mollieInfo['key'] : null }}">
                  @if ($errors->has('key'))
                    <p class="mb-0 text-danger">{{ $errors->first('key') }}</p>
                  @endif
                </div>
              ...
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="public_key"
                    value="{{ isset($flutterwaveInfo) ? $flutterwaveInfo['public_key'] : null }}">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="secret_key"
                    value="{{ isset($flutterwaveInfo) ? $flutterwaveInfo['secret_key'] : null }}">
                  @if ($errors->has('secret_key'))
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="key"
                    value="{{ isset($razorpayInfo) ? $razorpayInfo['key'] : null }}">
                  @if ($errors->has('key'))
                    <p class="mb-0 text-danger">{{ $errors->first('key') }}</p>
                  @endif
                </div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="secret"
                    value="{{ isset($razorpayInfo) ? $razorpayInfo['secret'] : null }}">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input class="form-control" name="token"
                value="{{ isset($mercadopagoInfo) ? $mercadopagoInfo['token'] : null }}">
              @if ($errors->has('token'))
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="key"
                    value="{{ isset($stripeInfo) ? $stripeInfo['key'] : null }}">
                  @if ($errors->has('key'))
                    <p class="mb-0 text-danger">{{ $errors->first('key') }}</p>
                  @endif
                </div>
                <div class="form-group">
                  ...
                  <input class="form-control" name="secret"
                    value="{{ isset($stripeInfo) ? $stripeInfo['secret'] : null }}">
                  @if ($errors->has('secret'))
                    <p class="mb-0 text-danger">{{ $errors->first('secret') }}</p>
                  @endif
                </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                @php $myfatoorahInfo = isset($myfatoorah)  ? json_decode($myfatoorah->information, true) : []; @endphp
                <div class="form-group">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                @php $midtransInfo = isset($midtrans) ? json_decode($midtrans->information, true) : []; @endphp
              ...
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                      <input type="radio" name="sandbox_check" value="1" class="selectgroup-input"
                        {{ isset($paypalInfo) && $paypalInfo['sandbox_check'] == 1 ? 'checked' : '' }}>
                      <span class="selectgroup-button">{{ __('Active') }}</span>
                    </label>
                    <label class="selectgroup-item">
                      <input type="radio" name="sandbox_check" value="0" class="selectgroup-input"
                        {{ !isset($paypalInfo) || $paypalInfo['sandbox_check'] == 0 ? 'checked' : '' }}>
                      <span class="selectgroup-button">{{ __('Deactive') }}</span>
                    </label>
                  </div>
                </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                @php $toyyibpayInfo = isset($toyyibpay) ? json_decode($toyyibpay->information, true) : []; @endphp
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="key"
                    value="{{ isset($instamojoInfo) ? $instamojoInfo['key'] : null }}">
                  @if ($errors->has('key'))
                    <p class="mb-0 text-danger">{{ $errors->first('key') }}</p>
                  @endif
                </div>
                <div class="form-group">
                  ...
                  <input class="form-control" name="token"
                    value="{{ isset($instamojoInfo) ? $instamojoInfo['token'] : null }}">
                  @if ($errors->has('token'))
                    <p class="mb-0 text-danger">{{ $errors->first('token') }}</p>
                  @endif
                </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                @php $iyzicoInfo = isset($iyzico) ? json_decode($iyzico->information, true):[]; @endphp
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                @php $paytabsInfo = isset($paytabs) ? json_decode($paytabs->information, true) : []; @endphp
      ...
      <div class="card">
        <form class="" action="{{ route('user.phonepe.update') }}" method="post">
          ...
          <div class="card-body pt-5 pb-5">
            ...
            @csrf
            @php
              $phonePeInfo = isset($phonepe) ? json_decode($phonepe->information, true) : [];
            @endphp
            <div class="form-group">
              <label>PhonePe</label>
              <div class="selectgroup w-100">
            ...
            <div class="form-group">
              ...
              <div class="selectgroup w-100">
                <label class="selectgroup-item">
                  <input type="radio" name="sandbox_check" value="1" class="selectgroup-input"
                    {{ @$phonePeInfo['sandbox_check'] == 1 ? 'checked' : '' }}>
                  <span class="selectgroup-button">Active</span>
                </label>
                <label class="selectgroup-item">
                  <input type="radio" name="sandbox_check" value="0" class="selectgroup-input"
                    {{ @$phonePeInfo['sandbox_check'] == 0 ? 'checked' : '' }}>
                  <span class="selectgroup-button">Deactive</span>
                </label>
              </div>
            </div>
              ...
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="login_id"
                    value="{{ isset($anetInfo) ? $anetInfo['login_id'] : null }}">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="transaction_key"
                    value="{{ isset($anetInfo) ? $anetInfo['transaction_key'] : null }}">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="public_key"
                    value="{{ isset($anetInfo) ? $anetInfo['public_key'] : null }}">
                  @if ($errors->has('public_key'))
                    <p class="mb-0 text-danger">{{ $errors->first('public_key') }}</p>
                  @endif
                </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="secret"
                    value="{{ isset($paytmInfo) ? $paytmInfo['secret'] : null }}">
                  @if ($errors->has('secret'))
                    <p class="mb-0 text-danger">{{ $errors->first('secret') }}</p>
                  @endif
                </div>
                <div class="form-group">
                  ...
                  <input class="form-control" name="merchant"
                    value="{{ isset($paytmInfo) ? $paytmInfo['merchant'] : null }}">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="website"
                    value="{{ isset($paytmInfo) ? $paytmInfo['website'] : null }}">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="industry"
                    value="{{ isset($paytmInfo) ? $paytmInfo['industry'] : null }}">
