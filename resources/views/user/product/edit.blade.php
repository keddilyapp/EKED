          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <div>
                ...
                <form action="{{ route('user.product.slider.update') }}" id="my-dropzone" enctype="multipart/form-data"
                  class="dropzone">
                  @csrf
                  ...
                  <div class="col-lg-12">
                    <div class="form-group px-0">
                      ...
                      <div class="showImage mb-3">
                        <img
                          src="{{ Uploader::getImageUrl(Constant::WEBSITE_PRODUCT_FEATURED_IMAGE, $data->feature_image, $userBs) }}"
                              ...
                              <div class="col-3">
                                ...
                                <div class=" mb-2">
                                  ...
                                  <input type="text" required=""
                                    value="{{ $keywords['variation_name'][$key] ?? '' }}" class="form-control"
                                    placeholder="" name="{{ $lang->code }}_variation_{{ $v }}">

                                  <input type="hidden" name="variation_helper[]" value="{{ $v }}">
                                </div>
                              </div>
                            @endforeach
                                ...
                                <div class="repeater-child-item mb-3" id="options{{ $v . $okey }}">
                                  <div class="row align-items-start">
                                    ...
                                    <div class="col-2 ">
                                      ...
                                      <input required name="options2_{{ $v }}[]" type="text"
                                        class="form-control" value="{{ $variations[$vkey][$okey]['price'] }}"
                                        placeholder="0">
                    ...
                    @if (!empty($addonkeywords))
                      ...
                      @foreach ($addons as $akey => $addon)
                        @php
                          $a++;
                        @endphp
                        <div class=" mb-3 js-repeater-item js-repeater-item-addon " id="addonDiv{{ $a }}">
                          <div class="mb-3 row align-items-end">
                            @foreach ($userLangs as $lkey => $lang)
                              @php
                              ...
                              <div class="col-3">
                                ...
                                <div class="mb-2">
                                  ...
                                  <input required value="{{ $addonkeywords['addon_name'][$key] ?? '' }}"
                                    name="{{ $lang->code }}_addonoptions1_{{ $a }}[]" type="text"
                                    class="form-control" placeholder="">

                                  <input type="hidden" name="addon_variation_helper[]" value="{{ $a }}">
                                </div>
                              </div>
                            @endforeach
                            <div class="col-2 ">
                              <label for="form" class="form-label mb-1">Price
                                ({{ $userBe->base_currency_symbol }})</label>
                              <div class="mb-2">
                                <input required name="addonoptions2_{{ $a }}[]" type="text"
                                  class="form-control" value="{{ $addon['price'] }}" placeholder="0">
                              </div>
                            </div>
